        ...
        <div class="container-fluid">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Forgot Password Email</li>
            </ol>
          </nav>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header">
              <h6 class="m-0 font-weight-bold text-primary">Forgot Password Email</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
              ...
              <?php } ?>
              <!--  -->
              <form id="manage" action="<?= base_url("settings/actionforgotpassemail") ?>" method="post" enctype="multipart/form-data">
