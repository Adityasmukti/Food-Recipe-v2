...
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
$config['auth_override_class_method']['cianjur']['login'] = 'none';
...
$config['auth_override_class_method_http']['cianjurgo']['register']['post'] = 'none';
$config['auth_override_class_method_http']['cianjurgo']['login']['post'] = 'none';
